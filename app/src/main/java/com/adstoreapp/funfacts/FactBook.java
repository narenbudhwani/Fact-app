...
public class FactBook {
    ...
    public String[] mFacts = {
            ...
            "Michelle Druggar holds the record for largest human family, having given birth to 17 children.",
            ...
            //They are as individual as snowflakes, with no two ever being the same", Some tropical spiders have built webs over eighteen feet across",
    ...
    "Ramses brand condom is named after the great pharaoh Ramses II who fathered over 160 children",
            ...
            "1% of all US prisoners are in prison for drug offenses",
            ...
            "$203,000,000 is spent on barbed wire each year in the.",
            ...
            "The Michelin man is known as Bib. " + " His name was Bibendum in the company’s first ads in 1896",
            ...
            "Everyday, more money is printed for Monopoly sets than for the . Treasury",
...
//            "Rape is reported every six minutes in the ",
            ...
            "The . Post Office handles 43 percent of the world’s mail",
            ...
            "Go." +" Its the shortest complete sentence in the English language",
            ...
            "Nevada is the driest state in the. " + "Each year it averages 7.5 inches (19 cm) of rain",
            ...
            "Residents of Houston, Texas lead the . In eating out - approximately 4.6 times per week",


            "Laredo, Texas is the .'s farthest inland port",


            "Rugby, North Dakota is the geographical center of North America",


            //"//Butte County, South Dakota is the geographical center of the",


            //"Louisiana's capital building is the tallest one of any . State",
        ...
        //    "Gary, Indiana is the murder capital of the . - probably the world",
            ...
            "The . City with the highest rate of lightning strikes per capita is Clearwater, Florida",
            ...
            //"The . Bought Alaska for 2 cents an acre from Russia",
